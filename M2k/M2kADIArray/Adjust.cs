    ...
    public class Adjust
    {
        ...
        public override string ToString()
        {
            ...
            return !string.IsNullOrEmpty(LotNumber)
                ...
                : $"1~{TranType}~2~{StationId}~3~{TranTime}~4~{TranDate}~5~{FacilityCode}~6~{Reference}~8~{ItemNumber}~10~{ReasonCode}~12~{TranOperation}~13~{TranQuantity}~14~{Location}~99~COMPLETE";
        }
    }
}
